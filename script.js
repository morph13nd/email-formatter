document.addEventListener('DOMContentLoaded', function() {
    console.log("Email formatter script loaded"); // Debug message to confirm loading
    ...
    // Event listener for the Convert Format button
    convertButton.addEventListener('click', function() {
        console.log("Convert button clicked"); // Debug message
    ...
    function reformatEmail(emailContent, fullName) {
        try {
            ...
            let firstSenderEmail = ''; // Declare this variable to avoid undefined reference
            ...
            let origSenderEmail = '';
            let recipientEmail = '';
            let secondSentDateTime = ''; // Declare this variable to avoid undefined reference
            let cleanSubject = ''; // Declare this variable to avoid undefined reference
            ...
            cleanSubject = secondSubjectLine.replace(/^Subject: /, '').replace(/^(FW:|RE:|FWD:)\s*/i, "").trim();
